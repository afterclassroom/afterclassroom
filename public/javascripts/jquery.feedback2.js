...
(function($) {
  ...
  $.fn.feedback2 = function(callerSettings) {
    settings = $.extend({
      main: 'feedback',
    ...
    settings.tabHtml = '<a href="#" id="feedback_link2" class="feedback_link2 ' + settings.tabPosition + '"></a>';
    ...
    if (settings.tabPosition != null && $("#feedback_link2").length == 0) {
      $("body").append(settings.tabHtml);
      settings.tabControls = $(settings.tabControls).add($('#feedback_link2'));
    }
