...
PRIVATE_SETTING = ["about_myself", "sex", "relationship_status", "looking_for", "plitical_views", "mobile_number", "current_city", "my_friends", "my_fans", "my_photos", "my_musics"]
OPTIONS_SETTING = [["Option to share", 0], ["Friend from school", 1], ["Friend of friends", 2], ["My Family", 3], ["My Family", 3], ["Friends from work", 4], ["Every one", 5]]
PER_PAGE = 10
LIMIT = 5