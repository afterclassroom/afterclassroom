...
PRIVATE_SETTING = ["about_myself", "sex", "relationship_status", "looking_for", "plitical_views", "mobile_number", "current_city", "my_friends", "my_fans", "my_photos", "my_musics", "my_stories", "my_links"]
