...
PRIVATE_SETTING = ["about_myself", "sex", "relationship_status", "looking_for", "plitical_views", "mobile_number", "current_city", "my_lounges", "my_friends", "my_fans", "my_photos", "my_musics", "my_stories", "my_links"]
OPTIONS_SETTING = [["Private", 0], ["Friend from school", 1], ["Friend of friends", 2], ["My Family", 3], ["My friends", 4], ["Friends from work", 5], ["Every one", 6]]
PER_PAGE = 10
LIMIT = 5
# Upload file
