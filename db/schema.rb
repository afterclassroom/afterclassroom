...
ActiveRecord::Schema.define(:version => 20120114040935) do
  ...
  create_table "omnitauths", :force => true do |t|
    t.integer  "user_id"
    t.string   "provider"
    t.string   "uid"
    t.datetime "created_at"
  ...
  create_table "post_lecture_notes", :force => true do |t|
    t.integer  "post_id"
    t.string   "professor"
    t.datetime "due_date"
  end
  ...
  create_table "ufo_cmts", :force => true do |t|
    t.integer  "user_id",                  :null => false
  ...
  create_table "ufo_members", :force => true do |t|
    t.integer  "user_id",    :null => false
    t.integer  "ufo_id",     :null => false
    t.datetime "created_at"
    t.datetime "updated_at"
